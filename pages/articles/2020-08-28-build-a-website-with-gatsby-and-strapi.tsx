...
The main difference here - you have <b>Headless CMS</b> that manages your data rather than you have to store data as code. It brings your some level of complexity where you have to manage your infrastracture (Host Strapi, database and their availability)
        ...
        <p>By going from line to line in the script above you might have seen there is `STRAPI_WEBHOOK_AUTH_TOKEN`. I'd like to cover up this point and go through Strapi setup to show how things are set there. To see all webhooks that are available in your strapi application go to Settings tab</p>
