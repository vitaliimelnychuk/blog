...
function IconContainer({
  ...
  href,
  ariaLabel,
}: React.PropsWithChildren<SocialIconLinkProps>) {
  return (
    <Link
      href={href}
...
export function TwitterIcon({ className = '' }: SocialIconProps) {
  return (
    <IconContainer href={twitterProfileLink} ariaLabel="Follow on Twitter">
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
        className={clsx(
...
export function InstagramIcon({ className = '' }: SocialIconProps) {
  return (
    <IconContainer href="https://instagram.com" ariaLabel="Follow on Instagram">
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
        className={clsx(
...
export function GitHubIcon({ className = '' }: SocialIconProps) {
  return (
    <IconContainer href={githubProfileLink} ariaLabel="Follow on GitHub">
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
        className={clsx(
...
export function LinkedInIcon({ className = '' }: SocialIconProps) {
  return (
    <IconContainer href={linkedinProfileLink} ariaLabel="Follow on LinkedIn">
      <svg
        viewBox="0 0 24 24"
        className={clsx(
          (className =
